...
int main(int argc, char** argv) {
    ...
    bool validar,permiso5, permiso6, permiso7, permiso8, permiso9, permiso10;
    bool valido = false;
    ...
    permiso10 = tienePermiso(10, permisos);
    ...
    while (opcion != 0) {
        ...
        cin >> opcion;
        cout << endl;
        ejecutarOpcion(opcion, valido, vectorComponentes, permisos, archivoTexto, permiso5, permiso6, contenidoTexto, validar, archivoEntrada, archivoSalida,permiso7, permiso8,permiso9,permiso10);
    }
