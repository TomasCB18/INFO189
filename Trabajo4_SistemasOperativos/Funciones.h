...
void ejecutarOpcion(int opcion,bool valido, const vector<int>& vectorComponentes, const vector<int>& permisos, const string& archivoTexto, bool permiso5, bool permiso6, const string& contenidoTexto, bool validar,const string& archivoEntrada, const string& archivoSalida, bool permiso7, bool permiso8, bool permiso9);
